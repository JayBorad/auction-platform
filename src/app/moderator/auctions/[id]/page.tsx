...
export default function ModeratorAuctionDetailsPage() {
  ...
  // Set default bid amount to minimum bid when auction data changes
  useEffect(() => {
    if (auction?.currentPlayer && auction?.status === "live" && !bidAmount) {
      const minimumBid = (auction.currentBid?.amount || auction.currentPlayer?.basePrice || 0) + (auction.rules?.maxBidIncrement || 500000);
      setBidAmount(minimumBid.toString());
    }
  }, [auction?.currentPlayer?._id, auction?.currentBid?.amount, auction?.rules?.maxBidIncrement, auction?.status, bidAmount]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      {/* Header */}
      <div className="sticky -top-2 z-30 bg-gray-900/95 backdrop-blur-md border-b border-gray-700">
                  ...
                  <CardHeader>
                    <div className="flex gap-4 flex-wrap items-center justify-between">
                      ...
                      <Button
                        ...
                        size="sm"
                        disabled={isControlling}
                        className="border-gray-600 hover:bg-gray-700 max-sm:h-7"
                      >
