      ...
      >
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          >
            ...
            <DialogContent className="bg-gray-900 border-gray-700 max-h-[90vh] overflow-y-auto max-sm:p-4">
              <DialogHeader>
      ...
      <motion.div variants={itemVariants}>
        <Tabs defaultValue="auctions" className="space-y-6">
          ...
          <TabsContent value="auctions" className="space-y-6">
            {/* Filters */}
            <motion.div
              className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-gray-900/80 to-gray-800/80 border border-gray-700/50 backdrop-blur-md"
              variants={itemVariants}
            >
                ...
                auctions.map((auction, index) => (
                  ...
                  >
                    <Card className="border-gray-700/50 bg-gradient-to-br from-gray-900/80 to-gray-800/80 shadow-lg h-full backdrop-blur-sm overflow-hidden hover:shadow-xl transition-all duration-300 group">
                      <CardHeader className="max-sm:p-4 pb-3">
