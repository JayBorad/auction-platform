...
import { Plus, Search, Edit, Trash2, Users, Trophy, Target, Phone, Mail, MapPin, Calendar, Loader2, ChevronLeft, ChevronRight, MoreVertical, Star } from 'lucide-react';
import { motion } from 'framer-motion';
import { toast } from 'sonner';
import { useTeams, Team, CreateTeamData, Player } from '@/hooks/useTeams';
          ...
          <Dialog open={isCreateDialogOpen || editingTeam !== null} onOpenChange={(open) => {
            ...
            <DialogContent className="bg-gray-900 border-gray-700 max-w-4xl max-h-[90vh] overflow-y-auto max-sm:p-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            setFormData(prev => ({ ...prev, foundedYear: yearValue }));
                          }}
                          className="bg-gray-800 border-gray-600 text-white"
                          min="1800"
                      ...
                      <div className="grid sm:grid-cols-2 gap-4 mb-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              const ageValue = e.target.value === '' ? 25 : parseInt(e.target.value) || 25;
                              setFormData(prev => ({
                                ...prev,
                                captain: typeof prev.captain === 'object'
                                  ? { ...prev.captain, age: ageValue }
                                  : prev.captain
                              }));
                            }}
                            className="bg-gray-800 border-gray-600 text-white"
                      ...
                      <div className="grid sm:grid-cols-3 gap-4 mb-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              const jerseyValue = e.target.value === '' ? 1 : parseInt(e.target.value) || 1;
                              setFormData(prev => ({
                                ...prev,
                                captain: typeof prev.captain === 'object'
                                  ? { ...prev.captain, jerseyNumber: jerseyValue }
                                  : prev.captain
                              }));
                            }}
                            className="bg-gray-800 border-gray-600 text-white"
                      ...
                      <div className="grid sm:grid-cols-3 gap-4 mb-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              const jerseyValue = e.target.value === '' ? 2 : parseInt(e.target.value) || 2;
                              setFormData(prev => ({
                                ...prev,
                                viceCaptain: typeof prev.viceCaptain === 'object'
                                  ? { ...prev.viceCaptain, jerseyNumber: jerseyValue }
                                  : prev.viceCaptain
                              }));
                            }}
                            className="bg-gray-800 border-gray-600 text-white"
                      ...
                      <div className="grid sm:grid-cols-2 gap-4 mb-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              const ageValue = e.target.value === '' ? 18 : parseInt(e.target.value) || 18;
                              setCurrentPlayer(prev => ({ ...prev, age: ageValue }));
                            }}
                            className="bg-gray-800 border-gray-600 text-white"
                            min="16"
                            max="50"
                      ...
                      <div className="grid sm:grid-cols-3 gap-4 mb-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              const jerseyValue = e.target.value === '' ? 1 : parseInt(e.target.value) || 1;
                              setCurrentPlayer(prev => ({ ...prev, jerseyNumber: jerseyValue }));
                            }}
                            className="bg-gray-800 border-gray-600 text-white"
                            min="1"
                            max="99"
              ...
              <DialogFooter className="flex justify-between">
                ...
                <Button disabled={isSubmitting} variant="outline" onClick={() => {
                    resetForm();
                    setEditingTeam(null);
                    setIsSubmitting(false);
                    setValidationErrors({
                  ...
                  {currentStep !== 'basic' && (
                    <Button disabled={isSubmitting} variant="outline" onClick={handlePreviousStep} className="border-gray-600 text-gray-300">
                      Previous
                    </Button>
                  )}
                </div>
